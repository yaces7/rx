...
const Home = () => {
  const projects = [
    ...
    { name: "Felsefe Sunu", description: "FELSEFE", url: "https://drive.google.com/file/d/1cNcrlnaXJxwRA1ZtDgrGearQqDiI-Q0j/view?usp=drivesdk", language: "react", extraLanguage: "javascript" },
